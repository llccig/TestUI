...
namespace TestUI.Web.Menus
{
    public class TestUIMenuContributor : IMenuContributor
    {
        private readonly IConfiguration _configuration;

        public TestUIMenuContributor(IConfiguration configuration)
        {
        ...
        private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
        {
            ...
            var l = context.GetLocalizer<TestUIResource>();

            context.Menu.Items.Insert(0, new ApplicationMenuItem(TestUIMenus.Home, l["Menu:Home"], "~/"));
